...
if (isset($_POST['login'])) {
 ...
 if (isset($_POST['login'])) {
    ...
    $stmt = $pdo->prepare("SELECT staff_id, staff_email, staff_password FROM rpos_staff WHERE staff_email = :email AND staff_password = :password");
    $stmt->execute(['email' => $staff_email, 'password' => $staff_password]);
